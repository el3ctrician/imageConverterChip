...
HD_PWD='/home/el3ctrician/PrimaProva/PrimaProva.runs/input_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log input_memory.vds -m64 -mode batch -messageDb vivado.pb -notrace -source input_memory.tcl
