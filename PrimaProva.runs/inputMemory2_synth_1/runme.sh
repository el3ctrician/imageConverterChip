...
HD_PWD='/home/el3ctrician/PrimaProva/PrimaProva.runs/inputMemory2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inputMemory2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source inputMemory2.tcl
