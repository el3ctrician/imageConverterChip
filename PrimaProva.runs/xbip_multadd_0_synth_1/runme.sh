...
HD_PWD='/home/el3ctrician/PrimaProva/PrimaProva.runs/xbip_multadd_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xbip_multadd_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source xbip_multadd_0.tcl
