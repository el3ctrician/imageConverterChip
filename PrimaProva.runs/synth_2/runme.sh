...
HD_PWD='/home/el3ctrician/PrimaProva/PrimaProva.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log FullChip.vds -m64 -mode batch -messageDb vivado.pb -notrace -source FullChip.tcl
