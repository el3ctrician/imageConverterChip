...
HD_PWD='/home/el3ctrician/PrimaProva/PrimaProva.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log FullChip.vdi -applog -m64 -messageDb vivado.pb -mode batch -source FullChip.tcl -notrace
