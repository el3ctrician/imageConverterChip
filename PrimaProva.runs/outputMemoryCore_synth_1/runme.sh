...
HD_PWD='/home/el3ctrician/PrimaProva/PrimaProva.runs/outputMemoryCore_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log outputMemoryCore.vds -m64 -mode batch -messageDb vivado.pb -notrace -source outputMemoryCore.tcl
