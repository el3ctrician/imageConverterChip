...
#
# Generated by export_simulation on Tue Jul 26 01:12:21 CEST 2016
#
################################################################################
...
switch to the './inputMemory2.sh' script.

./inputMemory2.sh -reset_run
...
./inputMemory2.sh -noclean_files

For more information on the script, please type './inputMemory2.sh -help'.
