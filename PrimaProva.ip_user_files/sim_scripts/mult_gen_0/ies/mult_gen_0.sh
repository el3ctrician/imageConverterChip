...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../PrimaProva.srcs/sources_1/ip/mult_gen_0/sim/mult_gen_0.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.mult_gen_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.mult_gen_0 -input simulate.do
}
# Script usage
usage()
{
