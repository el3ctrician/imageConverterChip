...
#
# Generated by Vivado on Mon Jun 13 17:16:40 CEST 2016
...
# Script info
echo -e "xbip_multadd_0.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./xbip_multadd_0.sh -help\" for more information)\n"
  exit 1
fi
...
create_lib_mappings()
{
  libs=(xbip_utils_v3_0_5 xbip_pipe_v3_0_1 xbip_bram18k_v3_0_1 mult_gen_v12_0_10 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_1 xbip_dsp48_multadd_v3_0_1 xbip_multadd_v3_0_8 xil_defaultlib)
  file="cds.lib"
  dir="ies"
...
compile()
{
  ...
  ncvhdl -work xbip_multadd_v3_0_8 $opts_vhd \
    "$ref_dir/../../../ipstatic/xbip_multadd_v3_0_8/hdl/xbip_multadd_v3_0_vh_rfs.vhd" \
    "$ref_dir/../../../ipstatic/xbip_multadd_v3_0_8/hdl/xbip_multadd_v3_0.vhd" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../PrimaProva.srcs/sources_1/ip/xbip_multadd_0/sim/xbip_multadd_0.vhd" \
...
elaborate()
{
  ...
  libs="-libname secureip -libname xbip_utils_v3_0_5 -libname xbip_pipe_v3_0_1 -libname xbip_bram18k_v3_0_1 -libname mult_gen_v12_0_10 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_1 -libname xbip_dsp48_multadd_v3_0_1 -libname xbip_multadd_v3_0_8 -libname xil_defaultlib"
  ncelab $opts xil_defaultlib.xbip_multadd_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.xbip_multadd_0 -input simulate.do
}
# Script usage
usage()
{
