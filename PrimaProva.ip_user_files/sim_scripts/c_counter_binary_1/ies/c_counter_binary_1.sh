...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../PrimaProva.srcs/sources_1/ip/c_counter_binary_1/sim/c_counter_binary_1.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.c_counter_binary_1 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.c_counter_binary_1 -input simulate.do
}
# Script usage
usage()
{
