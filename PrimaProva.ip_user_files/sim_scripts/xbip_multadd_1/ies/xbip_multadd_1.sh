...
#
# Generated by Vivado on Mon Jun 13 17:17:09 CEST 2016
...
# Script info
echo -e "xbip_multadd_1.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./xbip_multadd_1.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../PrimaProva.srcs/sources_1/ip/xbip_multadd_1/sim/xbip_multadd_1.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.xbip_multadd_1 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.xbip_multadd_1 -input simulate.do
}
# Script usage
usage()
{
